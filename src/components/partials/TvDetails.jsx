...
const TvDetails = () => {
    ...
    >
      ...
      <div className="w-full flex">
        ...
        <div className="content ml-[5%] text-white">
          ...
          <Link className=" p-5 z-[50] bg-[#6556cd] rounded-lg" to={`${pathname}/trailer`}><i className="text-xl  mr-3 ri-play-fill"></i>Play Trailer</Link>
        </div>
      </div>
      ...
      <hr className="text-white mt-5 mb-5 border-none h-[2px] bg-zinc-500" />
      <h1 className="text-3xl font-black text-white">Seasons</h1>
      ...
      <div className=" w-[100%]   flex   overflow-y-hidden mb-5 p-5 ">
        ...
        )):(<h1 className="text-3xl mt-5 font-black text-gray-300 text-center">Nothing To Show</h1>)
      }
 ...
 {/* part 5 recommendations */}
        <hr className="text-white mt-8 mb-5 border-none h-[2px] bg-zinc-500"/>
        <h1 className="text-3xl font-black text-white">Related tvs</h1>

        <HorizontalCards data={info.recommendations.length >0 ? info.recommendations : info.simillar}/>
