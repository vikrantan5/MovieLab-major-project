...
const Tvshows = () => {
  document.title = 'MovieLab — TV Shows';
      ...
      <PageHeader
        ...
        right={
          <div className="hidden sm:block">
            <Dropdown title="Category" value={category} options={['on_the_air', 'popular', 'top_rated', 'airing_today']} func={(e) => setCategory(e.target.value)} />
          </div>
        }
      />
